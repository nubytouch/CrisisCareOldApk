        ...
        implements TransformationMethod, TextWatcher
{
    ...
    {
        private static final String TAG = "PasswordCharSequence";
        ...
        public void getChars(int start, int end, char[] dest, int off) {
            ...
            for (int i = start; i < end; i++) {
                if (! (i >= st && i < en)) {
                    ...
                    if ("-".equals(String.valueOf(mSource.charAt(i))) && (i== 5 || i == 11))
                        visible = true;
    ...
    private static Object ACTIVE = new NoCopySpan.Concrete();
}
