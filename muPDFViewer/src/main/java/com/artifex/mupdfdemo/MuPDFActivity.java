...
public class MuPDFActivity extends Activity implements FilePicker.FilePickerSupport
{
	...
	protected Class mOutlineActivityClass=OutlineActivity.class;
	protected Class mPrintDialogActivityClass=PrintDialogActivity.class;
	protected boolean mToolbarEnabled=true;
	...
	protected MuPDFCore openBuffer(byte buffer[], String magic)
	{
	...
	public void createUI(Bundle savedInstanceState) {
			...
			mOutlineButton.setOnClickListener(new View.OnClickListener() {
				public void onClick(View v) {
					...
					if (outline != null) {
						...
						Intent intent = new Intent(MuPDFActivity.this, mOutlineActivityClass);
		...
		mDocView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup
	...
	protected void printDoc() {
		...
		Intent printIntent = new Intent(this, mPrintDialogActivityClass);
	...
	private void makeButtonsView() {
		mButtonsView = getLayoutInflater().inflate(R.layout.buttons, (ViewGroup) findViewById(R.id.frame_layout), false);
	...
	public void onBackPressed() {
		if (core != null && core.hasChanges()) {
			...
			AlertDialog alert = mAlertBuilder.create();
			alert.setTitle(getString(R.string.pdf_reader));
